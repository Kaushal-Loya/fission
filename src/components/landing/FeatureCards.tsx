    ...
    <section id="features" className="relative py-32 border-t border-border/40">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          {/* WIDE CARD: DEP GRAPH */}
          <div className="lg:col-span-8 p-10 rounded-lg border border-border bg-card/30 relative overflow-hidden group">
          ...
          {/* STAT BLOCK: CI/CD */}
          <div className="lg:col-span-4 p-8 rounded-lg border border-border bg-card/30 flex flex-col justify-between">
            <div>
          ...
          <div className="lg:col-span-4 p-8 rounded-lg border border-border bg-card/30">
          ...
          <div className="lg:col-span-8 p-10 rounded-lg border border-border bg-primary/5 relative overflow-hidden group">
